...
require("pack").lazy({
	{
		...
		data = {
			lazy = {
				keys = {
					{ "n", "<F5>", "Debug continue" },
					{ "n", "<F4>", "Debug step into" },
					{ "n", "<F3>", "Debug step over" },
					{ "n", "<F2>", "Debug step out" },
					{ "n", "<F1>", "Debug step back" },
					{ "n", "<F6>", "Debug run last" },
					{ "n", "<F7>", "Debug terminate" },
					{ "n", "<F8>", "Debug disconnect" },
					{ "n", "<leader>dc", "Debug run to cursor" },
					{ "n", "<leader>du", "Debug step up callstack" },
					{ "n", "<leader>dd", "Debug step down callstack" },
					{ "n", "<leader>db", "Debug toggle breakpoint" },
					{ "n", "<leader>dw", "Debug watch expression" },
					{ "n", "yod", "Debug view toggle" },
				},
			},
		},
	},
