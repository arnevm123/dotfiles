-- Compile mode (lazy: keys)

-- vim.g config can be set eagerly (no plugin code needed)
---@module "compile-mode"
...
require("pack").lazy({
	...
	"https://github.com/nvim-lua/plenary.nvim",
	{
		...
		data = {
			lazy = {
				keys = {
					{ "n", "<leader>bu", "Compile: make build" },
					{ "n", "<leader>bt", "Compile: make test" },
					{ "n", "<leader>bl", "Compile: make lint" },
					{ "n", "<leader>bg", "Compile: prompt command" },
					{ "n", "<leader>br", "Compile: make run" },
					{ "n", "<leader>be", "Compile: recompile" },
					{ "n", "<leader>bd", "Delete compilation buffer" },
					{ "n", "<leader>bq", "Compile errors to quickfix" },
					{ "n", "]x", "Next compile error" },
					{ "n", "[x", "Previous compile error" },
					{ "n", "yox", "Toggle compilation buffer" },
				},
			},
		},
	},
